    ...
    >
      {project.thumbnail ? (
        <div className="relative aspect-video w-full overflow-hidden">
          ...
          />
          {/* Bottom-to-top gradient overlay - short, only bottom 30% */}
        ...
        <div className="relative aspect-video w-full overflow-hidden bg-gradient-to-br from-primary/5 to-primary/20">
          {/* Bottom-to-top gradient overlay for placeholder - short */}
          <div className="absolute bottom-0 left-0 right-0 h-[30%] bg-gradient-to-t from-white/15 to-transparent pointer-events-none" />
          <div className="absolute top-2 left-2">
            <TypeBadge type={project.type} />
          </div>
        </div>
